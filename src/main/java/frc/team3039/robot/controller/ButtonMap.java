package frc.team3039.robot.controller;
...
public class ButtonMap {
	...
	//Triggers
	public int BUTTON_LEFT_TRIGGER;
	public int BUTTON_RIGHT_TRIGGER;
	//Misc
	public int BUTTON_SHARE;
